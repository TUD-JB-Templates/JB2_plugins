      ...
      for (const [index, node] of rootChildren.entries()) {
        if (node.type === "container" && node.children[0]?.type === "iframe") {
          ...
          try {
            ...
            const buffer = await import_qrcode.default.toBuffer(url, { type: "png" });
            ...
            node.children = [
              {
                type: "image",
                url: `../images/qrcode_${node.qr_index}.png`,
                // make sure
                alt: "QR code",
              ...
              { type: "caption", children: [{ type: "paragraph", children: [{ type: "text", value: "scan the QR code to open the link or click " }, { type: "link", url, children: [{ type: "text", value: "here" }] }, { type: "text", value: " to open the link." }] }] }
            ];
          } catch (err) {
...
var pdf_iframe_default = plugin;
export {
  pdf_iframe_default as default
};
